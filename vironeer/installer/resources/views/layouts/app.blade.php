...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/vendor/installer/img/favicon.ico') }}" type="image/png" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/installer/css/app.min.css') }}" />
</head>
        ...
        <div class="container">
            <div class="vironeer-navbar-inner">
                <a href="https://vironeer.com" class="vironeer-logo" target="_blank">
                    <img src="{{ asset('assets/vendor/installer/img/logo.png') }}" alt="Vironeer" />
                </a>
