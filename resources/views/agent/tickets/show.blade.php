...
@section('title', str(translate('Ticket #{number}', 'tickets'))->replace('{number}', $ticket->id))
        ...
        <div class="col-12 col-xl-8">
            <div class="row row-cols-1 g-3">
                                        ...
                                        <div class="col">
                                            <div class="tickets-user">
                                                ...
                                                @if (!$reply->user->isUser())
                                                    <div class="badge bg-primary ms-2">{{ translate('Support', 'tickets') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="ticket-content">
                                    ...
                                    <div class="tickets-paragrah">
                                        ...
                                        @if ($reply->attachments->count() > 0)
                                            <div class="mt-4">
                                                <h6 class="text-dark mb-3">{{ translate('Attached files', 'tickets') }}:
                                                </h6>
                                                <div class="row g-2">
                ...
                <div class="col">
                    <div class="card-v p-4">
                        <div class="p-2">
                            <h5 class="mb-3">{{ translate('Reply', 'tickets') }}</h5>
                            <form action="{{ route('agent.tickets.reply', $ticket->id) }}" method="POST"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="attachments">
                                            <div class="attachment-box-1">
                                                <label class="form-label">{{ translate('Attachments', 'tickets') }}
                                ...
                                <button class="btn btn-primary btn-md">{{ translate('Send', 'tickets') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-4">
            <div class="card-v p-4 mb-3">
                <div class="border-bottom pb-3 mb-3">
                    <h6 class="mb-0">{{ translate('User details', 'tickets') }}</h6>
                </div>
                ...
                <div class="p-2">
                    <div class="border-bottom pb-3 mb-3">
                        <div class="row row-cols-auto align-items-center justify-content-between g-2">
                            <div class="col">
                                <h6 class="mb-0">
                                    {{ str(translate('Ticket #{number}', 'tickets'))->replace('{number}', $ticket->id) }}
                                </h6>
                            </div>
                            <div class="col">
                                @if ($ticket->isOpened())
                    ...
                    <div class="row row-cols-1 justify-content-between align-items-center g-3">
                        ...
                        <div class="col">
                            <div class="row row-cols-auto justify-content-between">
                                <div class="col">
                                    {{ translate('Created Date', 'tickets') }}:
                                </div>
                                <div class="col">
                        ...
                        <div class="col">
                            <div class="row row-cols-auto justify-content-between">
                                <div class="col">
                                    {{ translate('Last Activity', 'tickets') }}:
                                </div>
                                <div class="col">
                        ...
                        @if ($ticket->isOpened())
                            <form action="{{ route('agent.tickets.close', $ticket->id) }}" method="POST">
                                ...
                                <button class="btn btn-danger btn-md w-100 action-confirm mb-3">
                                    ...
                                    {{ translate('Close ticket', 'tickets') }}
                                </button>
                            </form>
                        @endif
                        <button class="btn btn-secondary btn-md w-100" data-bs-toggle="modal"
                            data-bs-target="#transferModal"><i
                                class="fa-solid fa-share me-2"></i>{{ translate('Transfer', 'tickets') }}</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="transferModalLabel">
                        {{ str(translate('Transfer ticket #{number}', 'tickets'))->replace('{number}', $ticket->id) }}</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary"
                        data-bs-dismiss="modal">{{ translate('Cancel', 'tickets') }}</button>
                    <button form="transferForm"
                        class="btn btn-primary action-confirm">{{ translate('Transfer', 'tickets') }}</button>
                </div>
            </div>
        </div>
    </div>
